          ...
          <nav className="space-y-1">
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                activeTab === 'profile' ? 'bg-amber-50 text-amber-600' : 'text-stone-700 hover:bg-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                activeTab === 'organization' ? 'bg-amber-50 text-amber-600' : 'text-stone-700 hover:bg-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                activeTab === 'notifications' ? 'bg-amber-50 text-amber-600' : 'text-stone-700 hover:bg-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                activeTab === 'security' ? 'bg-amber-50 text-amber-600' : 'text-stone-700 hover:bg-white'
              }`}
            >
...
function ProfileSettings({ user, saving, setSaving, message, setMessage }: any) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6">
      <h2 className="text-lg font-semibold text-stone-900 mb-4">Profile Settings</h2>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            value={form.email}
            disabled
            className="w-full px-4 py-2.5 border border-stone-200 rounded-lg bg-white text-stone-500"
          />
...
function OrganizationSettings({ organization, saving, setSaving, message, setMessage }: any) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6">
      <h2 className="text-lg font-semibold text-stone-900 mb-4">Organization Settings</h2>
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-stone-700 mb-1.5">Primary Use Case</label>
          <select
            value={form.intent}
...
function NotificationSettings({ saving, setSaving, message, setMessage }: any) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6">
      <h2 className="text-lg font-semibold text-stone-900 mb-4">Notification Settings</h2>
      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="text-sm text-stone-700">Call summaries after each call</span>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-4 h-4 accent-brand-600"
            />
            <span className="text-sm text-stone-700">Daily activity digest</span>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-4 h-4 accent-brand-600"
            />
            <span className="text-sm text-stone-700">Campaign completion alerts</span>
          </label>
        </div>

        <div className="border-t border-stone-200 pt-4 mt-4">
          <h3 className="text-sm font-medium text-stone-700 mb-3">Webhooks</h3>
          ...
          <label className="flex items-center gap-3 cursor-pointer mb-3">
            <input
              ...
              className="w-4 h-4 accent-brand-600"
            />
            <span className="text-sm text-stone-700">Enable webhook notifications</span>
          </label>

          {settings.webhookEnabled && (
            <div>
              <label className="block text-xs text-stone-500 mb-1">Webhook URL</label>
              <input
                type="url"
...
function SecuritySettings({ saving, setSaving, message, setMessage }: any) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6">
      <h2 className="text-lg font-semibold text-stone-900 mb-4">Security Settings</h2>
